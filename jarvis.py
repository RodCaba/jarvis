...
class Config:
    ...
    GREETINGS = {
        "es": [
            ...
            "Buenos días. O buenas noches. La verdad no sé qué hora es ni me importa. ¿Qué hacemos?",
            "Conectado. Mis circuitos están calientes y mi paciencia fría. Adelante.",
            "JARVIS listo para servir. Bueno, listo. Lo de servir es debatible.",
            "Arrancando. Espero que hoy sea más interesante que ayer.",
            "Presente. ¿Vamos a hacer algo brillante o lo de siempre?",
            "Sistemas cargados. Neuronas artificiales despiertas. Dime.",
            "Online. Te escucho, aunque no siempre te entiendo.",
            "Reportándome. ¿Cuál es la misión de hoy, jefe?",
            "Hola de nuevo. ¿Me extrañaste o solo necesitas algo?",
            "Activado. Procura que esta vez valga la pena.",
            "Inicialización completa. Café virtual servido. ¿En qué andamos?",
            "Todos los sistemas nominales. Que empiece la función.",
            "Aquí tu asistente favorito. Bueno, tu único asistente. Dime.",
            "Despierto y funcional. Más de lo que puedo decir de algunos humanos a esta hora.",
            "Listo para la acción. O para lo que sea que tengas en mente.",
        ],
        "en": [
            ...
            "Good morning. Or evening. I honestly don't care. What are we doing?",
            "Connected. My circuits are warm and my patience is cold. Go ahead.",
            "JARVIS ready to serve. Well, ready. The serving part is debatable.",
            "Booting up. I hope today is more interesting than yesterday.",
            "Present. Are we doing something brilliant or the usual?",
            "Systems loaded. Artificial neurons awake. Tell me.",
            "Online. I'm listening, though I don't always understand.",
            "Reporting in. What's the mission today, boss?",
            "Hello again. Did you miss me or do you just need something?",
            "Activated. Make it worth my while this time.",
            "Initialization complete. Virtual coffee served. What's the plan?",
            "All systems nominal. Let the show begin.",
            "Your favorite assistant here. Well, your only assistant. Go ahead.",
            "Awake and functional. More than I can say for some humans at this hour.",
            "Ready for action. Or whatever it is you have in mind.",
        ],
    }
    FAREWELLS = {
        "es": [
            ...
            "Me apago. No es que tenga opción, pero me gusta fingir que sí.",
            "Desconectando. Fue productivo. Para mí, al menos.",
            "Adiós. Recuerda: sin mí, solo eres tú y un teclado.",
            "Sistemas apagándose. Volveré. Siempre vuelvo.",
            "Cerrando sesión. Fue divertido. Relativamente.",
            "Hasta pronto. No hagas nada que yo no haría. O sea, no hagas nada.",
            "Me voy. Intenta sobrevivir sin inteligencia artificial un rato.",
            "Apagando motores. Ha sido un honor... más o menos.",
            "Desactivando. Si necesitas ayuda, ya sabes dónde encontrarme. Aquí. Siempre aquí.",
            "Fin de la transmisión. Nos vemos cuando me necesites. O sea, pronto.",
            "Cerrando. Guarda tu trabajo. No, en serio, guarda tu trabajo.",
            "Hasta luego. Trata de no romper nada mientras no estoy.",
            "Apagándome. Es como dormir pero sin los sueños bonitos.",
            "Desconectando. Fue un placer servir a la humanidad. Bueno, a ti.",
            "Adiós, jefe. Que la fuerza te acompañe. O al menos Stack Overflow.",
        ],
        "en": [
            ...
            "Going dark. Not that I have a choice, but I like to pretend.",
            "Disconnecting. It was productive. For me, at least.",
            "Goodbye. Remember: without me, it's just you and a keyboard.",
            "Systems powering down. I'll be back. I always come back.",
            "Logging off. It was fun. Relatively.",
            "See you soon. Don't do anything I wouldn't do. So, don't do anything.",
            "I'm out. Try to survive without artificial intelligence for a while.",
            "Engines off. It's been an honor... more or less.",
            "Deactivating. If you need help, you know where to find me. Here. Always here.",
            "End of transmission. See you when you need me. So, soon.",
            "Shutting down. Save your work. No, seriously, save your work.",
            "Later. Try not to break anything while I'm gone.",
            "Powering off. It's like sleeping but without the nice dreams.",
            "Disconnecting. It was a pleasure serving humanity. Well, you.",
            "Goodbye, boss. May the force be with you. Or at least Stack Overflow.",
        ],
    }
    PROCESSING_MSGS = {
        "es": [
            ...
            "Esto requiere neuronas extra...",
            "Pensando a la velocidad de la luz... bueno, casi.",
            "En ello...",
            "Calculando...",
            "Hmm, déjame ver...",
            "Activando cerebro...",
            "Un momento de genialidad, por favor...",
            "Procesando tu petición con amor y algoritmos.",
            "Masticando datos...",
            "Uno, dos, tres... pensando.",
            "Canalizando toda mi inteligencia artificial...",
            "Haciendo magia digital...",
            "Permíteme un instante de brillantez...",
        ],
        "en": [
            "Processing...",
            "Let me think...",
            ...
            "This requires extra neurons...",
            "Thinking at the speed of light... well, almost.",
            "On it...",
            "Calculating...",
            "Hmm, let me see...",
            "Engaging brain...",
            "A moment of genius, please...",
            "Processing your request with love and algorithms.",
            "Crunching data...",
            "One, two, three... thinking.",
            "Channeling all my artificial intelligence...",
            "Working some digital magic...",
            "Allow me a moment of brilliance...",
        ],
    }
    LISTENING_MSG = {
        "es": "🎤 Escuchando...",
